...
export class AppRelationshipFacade extends AppRuntimeFacade {
    ...
    public async acceptRelationshipCreationChange(
        relationshipId: string,
        content: any
    ): Promise<UserfriendlyResult<IdentityDVO>> {
    ...
    public async rejectRelationshipCreationChange(
        relationshipId: string,
        content: any
    ): Promise<UserfriendlyResult<IdentityDVO>> {
        const result = await this.transportServices.relationships.getRelationship({ id: relationshipId })
    ...
    public async revokeRelationshipCreationChange(
        relationshipId: string,
        content: any
    ): Promise<UserfriendlyResult<IdentityDVO>> {
        const result = await this.transportServices.relationships.getRelationship({ id: relationshipId })
    ...
    public async getRelationshipByAddress(
        request: GetRelationshipByAddressRequest
    ): Promise<UserfriendlyResult<IdentityDVO>> {
    ...
    public async acceptRelationshipChange(
        request: AcceptRelationshipChangeRequest
    ): Promise<UserfriendlyResult<IdentityDVO>> {
