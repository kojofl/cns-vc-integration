...
export class CoreDate extends CoreSerializable {
  ...
  public get date(): string {
    return this.dateTime.toISODate() as string;
  }
  ...
  public isWithin(
    ...
    if (typeof granularity !== "undefined") {
      return (
        this.dateTime.startOf(granularity) >
          start.dateTime.startOf(granularity) &&
  ...
  public isBefore(other: CoreDate, granularity?: DateTimeUnit): boolean {
    if (typeof granularity !== "undefined") {
      return (
        this.dateTime.startOf(granularity) < other.dateTime.startOf(granularity)
      );
    }
  ...
  public isSame(other: CoreDate, granularity: DateTimeUnit): boolean {
    if (typeof granularity !== "undefined") {
      return (
        this.dateTime.startOf(granularity).valueOf() ===
  ...
  public isSameOrAfter(other: CoreDate, granularity?: DateTimeUnit): boolean {
    if (typeof granularity !== "undefined") {
      return (
        this.dateTime.startOf(granularity) >=
        other.dateTime.startOf(granularity)
      );
    }
  ...
  public isBetween(
    ...
    return Interval.fromDateTimes(start.dateTime, end.dateTime).contains(
      this.dateTime
    );
  }
  ...
  protected static override preFrom(value: any): any {
    ...
    if (typeof value === "object") {
      if (typeof value.date === "undefined") {
        if (typeof value.toISOString !== "function") {
          throw new TransportError(
            "The provided object doesn't have an 'toISOString' string method."
          );
        }
    ...
    throw new TransportError(
      "The provided object is invalid cannot be deserialized."
    );
  }
