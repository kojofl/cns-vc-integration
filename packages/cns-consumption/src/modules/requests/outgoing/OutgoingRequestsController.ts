...
import {
    ...
    ICanCreateOutgoingRequestParameters
...
export class OutgoingRequestsController extends ConsumptionBaseController {
    ...
    public async createAndCompleteFromRelationshipTemplateResponse(
        params: ICreateAndCompleteOutgoingRequestFromRelationshipTemplateResponseParameters
        ...
        const peer =
            parsedParams.responseSource instanceof RelationshipChange
                ? parsedParams.responseSource.request.createdBy
                : parsedParams.responseSource.cache!.createdBy
        ...
        if (!(templateContent instanceof RelationshipTemplateContent)) {
            throw new ConsumptionError(
                "The content of the template is not supported as it is not type of RelationshipTemplateContent."
            )
        }
        ...
        const requestContent = existingRelationship
            ? templateContent.onExistingRelationship!
            : templateContent.onNewRelationship
    ...
    private async _complete(
        ...
        const responseSourceObjectCreationDate =
            responseSourceObject instanceof Message
