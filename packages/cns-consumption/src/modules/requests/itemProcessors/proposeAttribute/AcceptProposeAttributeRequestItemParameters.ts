 ...
 */
export interface AcceptProposeAttributeRequestItemParametersWithExistingAttributeJSON
 ...
 */
export interface AcceptProposeAttributeRequestItemParametersWithNewAttributeJSON
    extends AcceptRequestItemParametersJSON {
