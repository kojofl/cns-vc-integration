...
import {
    AbstractIdentityDescriptor,
    AbstractIdentityDescriptorJSON,
    IAbstractIdentityDescriptor
} from "./AbstractIdentityDescriptor"
...
export class DigitalIdentityDescriptor extends AbstractIdentityDescriptor implements IDigitalIdentityDescriptor {
    ...
    public static from(
        value: IDigitalIdentityDescriptor | Omit<DigitalIdentityDescriptorJSON, "@type"> | string
